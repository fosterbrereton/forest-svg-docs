...
// [khopps revisit 2018-03-30] BEGIN
// This changes the default for BIGINTS from enabled to disabled.
// The reason for this is purely to get around a Coverity problem.
// Once Coverity fixes their compiler, these lines should be deleted.
//
#if !defined(ADOBE_FNV_YES_BIGINTS) && !defined(ADOBE_FNV_NO_BIGINTS)
#define ADOBE_FNV_NO_BIGINTS 1
#endif
// [khopps revisit 2018-03-30] END
